        ...
        <header class="masthead">
            <div class="container d-flex h-100 align-items-center">
                <div class="mx-auto text-center">
                    ...
                    <a class="btn btn-primary" href="./php/info.php">PHP INFOS</a>
                    <a class="btn btn-primary" href="./php/userinfo.php">CLIENT INFOS</a>
                    <a class="btn btn-primary" href="./php/repas.php">REPAS</a>
                </div>
            </div>
        </header>
        <!-- About-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-lg-8 mx-auto text-center">
                        ...
                        <form class="form-inline d-flex" action="MAILO:romain.laval000@gmail.com?body=" method="POST">
